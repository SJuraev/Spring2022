...
public class List2 {
    ...
    public static void main(String[] args) {
        ...
        birds4.add("Mihawk");
        birds4.add("The Eagle");
        birds4.add("Jack Vorobey");
        birds4.add("Seagull");
        System.out.println(birds4);

        birds4.set(0, "Takanome Mihawk");
        birds4.set(1, "The Eagle of Degastan");
        birds4.set(2, "Captain Jack Sparrow");
        birds4.set(3, "Steven Seagull");
        System.out.println(birds4);

        int indexOfHawk = birds4.indexOf("Takanome Mihawk");
        birds4.set(indexOfHawk, "Mihawk");
        System.out.println(birds4);
